...
\begin{table}[H]
  \begin{tabular}{|L{8cm}|L{5cm}|l|}
    ...
    \hline
    BCCH MRI Research Facility & Associate Director - MRI Investigator Support Unit & Dec 2024 - Present \\
    \hline
  \end{tabular}
\end{table}
...
\begin{longtable}{|L{2cm}|L{3.6cm}|L{1cm}|L{2cm}|L{1.7cm}|L{2cm}|L{2cm}|}
  ...
  \hline
  Michael Smith 2025 Scholar Competition & Identifying The Structural and Functional Link In Preterm Infant Brain Recovery & C & & LOI Nov 2024 & \textbf{Alexander Weber} & n/a \\
  \hline
  BCCHRI - Catalyst Grant & Brain and Motor Development of Young Children & C & \$20,000 / year & Nov 2024 & Jill Zwicker, \textbf{Alexander Weber} & n/a \\
  \hline
  BCCHRI - Catalyst Grant & Brain development in infants who receive Calmer & C & \$20,000 / year & Dec 2024 & Liisa Holsti, Manon Ranger & Thiviya Selvanathan, \textbf{Alexander Weber} \\
  \hline
\end{longtable}
...
\hspace{1cm} Number of citations = \totalcitations%391
...
\begin{longtable}{ L{0.5cm}  L{15.2cm}  }
  ...
  \stepcounter{rowcount}\therowcount. & \bibentry{gardezipdlim5notneuronal2009}. CA (IF \ifnatneur; Citations \pdlim) \\
  ...
  \stepcounter{rowcount}\therowcount. & \bibentry{warsiBrainFractalBloodOxygen2013}. CA (IF \ifvisual; Citations \warsi) \\
  \stepcounter{rowcount}\therowcount. & \bibentry{anglinMetaboliteMeasurementsCaudate2013}. CA (IF \ifcmajo; Citations \anglin) \\
  \stepcounter{rowcount}\therowcount. & \bibentry{weberProtonMagneticResonance2014}. FA (IF \ifpsych; Citations \psychotropic) \\
  \stepcounter{rowcount}\therowcount. & \bibentry{weberPreliminaryStudyFunctional2014}. FA (IF \ifprog; Citations \psychopharm) \\
  ...
  \stepcounter{rowcount}\therowcount. & \bibentry{weberPreliminaryStudyEffects2014}. (IF \ifmagma; Citations \ethanol)  \\
  \stepcounter{rowcount}\therowcount. & *\bibentry{weberPathologicalInsightsQuantitative2018}. (IF \iffrontneur; Citations \pathological) \\
  ...
  \stepcounter{rowcount}\therowcount. & \bibentry{zhangQuantitativeAnalysisPunctate2019}. SA (IF \ifajnr; Citations \punctate) \\
              ...
              \stepcounter{rowcount}\therowcount. & *\bibentry{weberMyelinWaterImaging2020}. (IF \ifnmr; Citations \rtwostar) \\
...
early life.} \\
  \stepcounter{rowcount}\therowcount. & \bibentry{weberQuantitativeSusceptibilityMapping2021}. FA (IF \ifajnr; Citations \perinatal)  \\
  \stepcounter{rowcount}\therowcount. & *\bibentry{campbellFractalBasedAnalysisFMRI2021}. Co-SA (IF \iffrontphys; Citations \campbellfractal) \\
...
influence the design of future neuroimaging studies.} \\
  \stepcounter{rowcount}\therowcount. & \bibentry{campbellMonofractalAnalysisFunctional2022}. SA (IF \ifhbm; Citations \campbellreview) \\
  \stepcounter{rowcount}\therowcount. & \bibentry{bartelsOrientationDependenceR22022}. Co-SA (IF \ifneurimag; Citations \bartel) \\
  \stepcounter{rowcount}\therowcount. & \bibentry{fothergillEffectsWearing3Ply2023}. Co-SA (IF \ifjmri; Citations \fothergill) \\
  \stepcounter{rowcount}\therowcount. & \bibentry{weber_cerebrovascular_reactivity_2023}. FA (IF \iftopics; Citations \sci) \\
  \stepcounter{rowcount}\therowcount. & \bibentry{malikCorticalGreyMatter2024}. CA (IF \iffronthum; Citations \dcdcontrols) \\
  \stepcounter{rowcount}\therowcount. & \bibentry{malikm.a.ChangesCorticalGrey2024}. CA (IF \iffronthum; Citations \dcdchanges) \\
  \stepcounter{rowcount}\therowcount. & \bibentry{mcwilliamsIronDeficiencySleep2024}. CA (IF \ifnutrients; Citations \iron) \\
  \stepcounter{rowcount}\therowcount. & \bibentry{drayneLongRangeTemporalCorrelation2024} SA (IF n/a; Citations 1)\\
  \stepcounter{rowcount}\therowcount. & *\bibentry{mellaTemporalComplexityBOLDSignal2024} SA (IF \ifcercor; Citations 1)\\
    ...
    \stepcounter{rowcount}\therowcount. & \bibentry{carmichael-etal-magnetic} SA (IF \ifpedres; Citations 0) \\
\end{longtable}
