...
\begin{longtable}{ L{0.5cm}  L{15.2cm}  }
  ...
  \rownumber. & Human Brain Mapping - January, 2025 \\
\end{longtable}
...
influence the design of future neuroimaging studies.} \\
  ...
  \stepcounter{rowcount}\therowcount. & \bibentry{drayneLongRangeTemporalCorrelation2024} SA (IF n/a; Citations \sickkids)\\
  \stepcounter{rowcount}\therowcount. & *\bibentry{mellaTemporalComplexityBOLDSignal2024} SA (IF \ifcercor; Citations \dhcp)\\
    ...
    \stepcounter{rowcount}\therowcount. & \bibentry{carmichael-etal-magnetic} SA (IF \ifpedres; Citations \carmichael) \\
    \stepcounter{rowcount}\therowcount. & \bibentry{zhu-etal-cmro2} \textit{ACCEPTED with revisions} SA (IF \ifnmr; Citations 0) \\
\end{longtable}
...
\begin{longtable}{ L{0.5cm}  L{15.2cm}  }
  ...
  \rownumber. & \bibentry{sochanDoesBrainsBalance2025} \\
\end{longtable}
...
\setcounter{magicrownumbers}{0}
\begin{longtable}{ L{0.5cm}  L{15.2cm}  }
      \rownumber. & \bibentry{sochan-etal-fmri}. \textit{Submitted to} Imaging Neuroscience\\
\end{longtable}
