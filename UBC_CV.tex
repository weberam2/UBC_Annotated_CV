...
%make table here so that I don't have to keep updating the number of references
\newcommand{\referencestable}{%
  \setcounter{rowcount}{0}
  \stepcounter{rowcount}\therowcount. & \bibentry{gardezipdlim5notneuronal2009}. CA (IF 21.13; Citations 15) \\
  \stepcounter{rowcount}\therowcount. & *\bibentry{weberNtypeCa2Channels2010}. FA (IF 21.13; Citations 131)\\
  ...
  \stepcounter{rowcount}\therowcount. & \bibentry{warsiBrainFractalBloodOxygen2013}. CA (IF 1.3; Citations 1) \\
  \stepcounter{rowcount}\therowcount. & \bibentry{anglinMetaboliteMeasurementsCaudate2013}. CA (IF 6.94; Citations 8) \\
  \stepcounter{rowcount}\therowcount. & \bibentry{weberProtonMagneticResonance2014}. FA (IF 11.22; Citations 32) \\
  \stepcounter{rowcount}\therowcount. & \bibentry{weberPreliminaryStudyFunctional2014}. FA (IF 5.07; Citations 33) \\
  ...
  \stepcounter{rowcount}\therowcount. & \bibentry{weberPreliminaryStudyEffects2014}. (IF 2.84; Citations 43)  \\
  \stepcounter{rowcount}\therowcount. & *\bibentry{weberPathologicalInsightsQuantitative2018}. (IF 4.00; Citations 24) \\
  ...
  \stepcounter{rowcount}\therowcount. & \bibentry{zhangQuantitativeAnalysisPunctate2019}. SA (IF 3.65 Citations 6) \\
  ...
  \stepcounter{rowcount}\therowcount. & *\bibentry{weberMyelinWaterImaging2020}. (IF 4.04 Citations 26) \\
...
early life.} \\
  \stepcounter{rowcount}\therowcount. & \bibentry{weberQuantitativeSusceptibilityMapping2021}. FA (IF 3.65 Citations 3)  \\
  \stepcounter{rowcount}\therowcount. & *\bibentry{campbellFractalBasedAnalysisFMRI2021}. Co-SA (IF 4.56 Citations 9) \\
...
influence the design of future neuroimaging studies.} \\
  \stepcounter{rowcount}\therowcount. & \bibentry{campbellMonofractalAnalysisFunctional2022}. SA (IF 5.04 Citations 21) \\
  \stepcounter{rowcount}\therowcount. & \bibentry{bartelsOrientationDependenceR22022}. Co-SA (IF 7.4 Citations 13) \\
  \stepcounter{rowcount}\therowcount. & \bibentry{fothergillEffectsWearingPly2023}. Co-SA (IF 4.62 Citations 0) \\
  \stepcounter{rowcount}\therowcount. & \bibentry{weber_cerebrovascular_reactivity_2023}. FA (IF 2.9 Citations 1) \\
  \stepcounter{rowcount}\therowcount. & \bibentry{malikCorticalGreyMatter2024}. CA (IF 2.33 Citations 1) \\
  \stepcounter{rowcount}\therowcount. & \bibentry{malikm.a.ChangesCorticalGrey2024}. CA (IF 2.33 Citations 2) \\
  \stepcounter{rowcount}\therowcount. & \bibentry{mcwilliamsIronDeficiencySleep2024}. CA (IF 5.7 Citations 1) \\
  \stepcounter{rowcount}\therowcount. & \bibentry{drayneLongRangeTemporalCorrelation2025} SA (IF n/a Citations 1)\\
  \stepcounter{rowcount}\therowcount. & *\bibentry{mellaTemporalComplexityBOLDSignal2025} SA (IF 3.7 Citations 1)\\
